...
import com.aswin.moviesupdate.Movie
import com.aswin.moviesupdate.R
import com.squareup.picasso.Picasso

class CombinedAdapter(private var combinedList: List<Movie>,private val onItemClick: (Int) -> Unit) : RecyclerView.Adapter<CombinedAdapter.ViewHolder>() {
